...
function ManageAdmin() {
	...
	const { data = [], status, count_data, message } = useSelector(fetchAdminsSelector);

	const { status: updateStatus, message: updateMessage } = useSelector(updateAdminSelector);
	const { status: deleteStatus, message: deleteMessage } = useSelector(deleteAdminSelector);
	const { status: createStatus, message: createMessage } = useSelector(createAdminSelector);
