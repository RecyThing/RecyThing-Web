    ...
    return (
            ...
            <div className="fixed top-0 left-0 w-full h-full bg-opacity-5 backdrop-blur flex justify-center items-center z-10" style={{ backgroundColor: "rgba(0, 0, 0, 0.05)"}}>
                <div className="bg-white p-6 rounded-lg">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex items-center border rounded-lg border-gray-400 w-full p-4 mb-6 relative">
                                        ...
                                        <tr key={field.id}>
                                                ...
                                                <div className="relative mt-4">
                                                    <Controller
                                                        ...
                                                        render={({ field }) => (
                                                            <select
                                                                {...field}
                                                                className="border rounded-lg border-gray-400 w-56 p-2 pl-3 text-sm appearance-none"
                                                                style={{ color: "#4F4F4F" }}
                                                            >
                                            ...
                                            <td>
                                                <input
                                                    ...
                                                    type="number"
                                                    className="border rounded-lg border-gray-400 w-32 p-2 pl-3 text-sm appearance-none mt-4"
                                                    style={{ color: "#4F4F4F" }}
        ...
        <div className="bg-white rounded-lg shadow-md mt-4 p-4 h-90%">
            <div className="flex justify-between items-center">
                ...
                <div className={`text-white font-inter font-medium text-lg flex items-center gap-2 p-3 w-44 h-12 rounded-md cursor-pointer ${isFocused ? 'ml-3' : ''}`} style={{ backgroundColor: "rgba(53, 204, 51, 1)" }} onClick={openForm}>
