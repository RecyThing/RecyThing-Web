...
function MissionList() {
	...
	const { status: updateStatus, message: updateMessage } = useSelector(updateMissionSelector);
	const { status: deleteStatus, message: deleteMessage } = useSelector(deleteMissionSelector);
	const { status: createStatus, message: createMessage } = useSelector(createMissionSelector);
