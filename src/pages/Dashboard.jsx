  ...
  return (
    <div className="p-6 w-full flex flex-col min-h-screen bg-[#EBEBF0] pb-10">
      ...
      <div className="grid grid-cols-4 gap-6 mt-5">
        <InfoCard title="Pengguna Aktif" count={1784} image={activeUserImage} percentage={0.1} />
        <InfoCard title="Transaksi Tukar Poin" count={145} image={voucherImage} percentage={-0.1} />
        <InfoCard title="Total Laporan" count={329} image={megaphoneImage} percentage={0.1} />
        <InfoCard title="Transaksi Daur Ulang" count={52} image={recycleImage} percentage={0.1} />
