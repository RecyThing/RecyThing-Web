...
function RubbishCategory() {
 ...
 const filteredData =
   data && data.length > 0
     ? Object.values(data).filter((trashes) => {
         return (
           (trashes.trash_type &&
             trashes.trash_type
               .toLowerCase()
