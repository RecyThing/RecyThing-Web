    ...
    <div className="p-6 w-full min-h-screen bg-[#EBEBF0]">
      ...
      <div className="mt-4 flex gap-9 pl-3 pr-6 py-6 rounded-xl min-h-[85vh] bg-white">
        <div  className="flex-1">
          ...
          <input value={articleData.title} onChange={(event) => setArticleData(prev => ({ ...prev, title: event.target.value }))} maxLength={50}
          className="w-full pl-6 py-4 rounded-xl border border-[#828282]" type="text" placeholder="Masukkan Judul Disini..." />
          <TextEditor text={articleData.content} setArticleData={setArticleData} peerHeight={categoryHeight} reduceHeight={101} />
        ...
        <div ref={categoryHeight} className="flex flex-col max-w-[328px]">
          ...
          <div className="mt-auto flex gap-3 justify-between text-white">
            ...
            <button disabled={isDeleteLoading || isEditLoading} onClick={handleEditArticle} className="p-4 w-full rounded-lg bg-[#35CC33] disabled:opacity-50 hover:opacity-90 flex gap-2 justify-center">
