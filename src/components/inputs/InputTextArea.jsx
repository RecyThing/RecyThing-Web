...
export const InputTextArea = forwardRef(
	({ className, label, ...props }, ref) => {
		...
		return (
			<div className={`relative ${className}`}>
				<textarea
					...
					className="resize-none block px-4 py-4 w-full text-sm text-gray-900 bg-transparent rounded-lg
      ...
      peer-placeholder-shown:px-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:top-8 peer-focus:top-1.5 peer-focus:scale-75 
