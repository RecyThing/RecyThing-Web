...
export function SideBar({ collapse, setCollapse }) {
	...
	return (
		<div
			className={`fixed px-6 pt-8 pb-6 hide-scrollbar transition-all overflow-scroll ${
				collapse ? "w-[96px] min-w-[96px]" : "w-[312px] min-w-[312px]"
			}
	bg-white z-10 min-h-screen max-h-screen border-r border-[#C7C9D9]`}
		>
			<img
				...
				src={collapse ? miniLogo : recyThingLogo}
				alt="recyThingLogo"
			/>
