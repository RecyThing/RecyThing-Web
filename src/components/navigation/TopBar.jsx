...
export default function TopBar({ setCollapse, collapse }) {
  return (
      ...
      <nav className="flex items-center w-full my-2 mx-4 h-11 gap-x-1">
        ...
        <div className="flex justify-end items-center w-full gap-x-2">
          <Popover placement="bottom-end">
            <PopoverTrigger>
              <Button bg={"white"} p={0} _hover={{ bg: "#F2F2F5" }}>
                <div className="flex items-center gap-x-2">
                  ...
                  <div className="text-info text-left">
                    <p className="text-xs font-medium" style={nameStyle}>
                      Admin Recything
                    </p>
