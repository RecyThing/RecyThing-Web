...
export const schema = yup.object().shape({
	...
	email: yup.string().required("Email tidak boleh kosong").min(5, "Email tidak boleh kurang dari 5 karakter").email("Email tidak valid"),
	password: yup
		.string()
		.required("Password tidak boleh kosong")
		.min(8, "Password tidak boleh kurang dari 8 karakter")
		.test("password", "Password dan Konfirmasi Password harus sesuai", function (value) {
	...
	confirm_password: yup
		...
		.test("confirm_password", "Password dan Konfirmasi Password harus sesuai", function (value) {
