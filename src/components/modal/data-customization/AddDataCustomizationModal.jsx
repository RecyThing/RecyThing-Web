...
export function AddDataCustomizationModal({ isOpen, onClose, setIsAddData }){
    ...
    return(
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent marginTop={"24"} maxW="900px" className="bg-white rounded-lg">
                ...
                <ModalBody>
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="w-full border rounded-xl p-3 relative" style={{ borderColor: "rgba(130, 130, 130, 1)"}}>
                            <textarea name="" id="" rows="8" className="w-full resize-none h-36 outline-none text-sm border-none bg-transparent" style={{ color: "rgba(79, 79, 79, 1)" }} placeholder="Masukkan pertanyaan"></textarea>
                        </div>
                    </form>
                </ModalBody>
