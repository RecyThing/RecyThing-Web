...
export function DeleteCategoryModal({ isOpen, onClose, target, onDelete }) {
  const handleDelete = () => {
    onDelete(target);
    onClose();
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size={"lg"} isCentered>
      ...
      >
        ...
        <ModalBody>
          <VStack spacing={"1.5rem"} textAlign={"center"}>
            <Text
              ...
              width={"400px"}
            >
              Anda yakin untuk Menghapus Kategori Sampah ini?
            </Text>
            <Text
              fontSize={"xl"}
              color={"#828282"}
        ...
        <ModalFooter pt={0} display={"flex"} justifyContent={"center"} gap={"3"}>
          <Button
            color={"white"}
            bg={"#828282"}
            borderRadius={"lg"}
