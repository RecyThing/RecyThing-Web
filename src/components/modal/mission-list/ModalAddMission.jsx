import { Box, Button, Flex, Grid, GridItem, Heading, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Text } from "@chakra-ui/react";
	...
	return (
		...
		>
			<ModalOverlay
				...
				closeOnOverlayClick={createStatus === "success"}
			/>
			<ModalContent
				borderRadius={"3xl"}
				gap={"1.5rem"}
