...
const MyMapPicker: FC<Props> = ({ apiKey, defaultLocation, zoom = 7, onChangeLocation, onChangeZoom, style, className, mapTypeId }) => {
    ...
    React.useEffect(() => {
        loadScript(`${GOOGLE_SCRIPT_URL + apiKey}&callback=Function.prototype`, 'google-maps-' + apiKey).then(loadMap);
