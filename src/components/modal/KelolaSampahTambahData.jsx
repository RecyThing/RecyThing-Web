...
export function KelolaSampahTambahData({ isOpen, onClose, setIsTambahData  }){
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent maxW="690px" className="bg-white rounded-lg max-h-[80vh] overflow-y-auto">
                <ModalHeader className="flex justify-between">
                    <h4 className="text-gray-800 text-2xl font-bold font-inter mb-2">Tambah Data Penukaran Sampah</h4>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="w-full">
                                                ...
                                                <div className="relative mt-6">
                                                    <Controller
                                                        ...
                                                        render={({ field }) => (
                                                            <select
                                                                {...field}
                                                                className="border rounded-lg w-52 p-2 pl-3 text-sm appearance-none"
                            ...
                            <div className="grid grid-cols-3 mt-6">
                                ...
                                <p className="text-sm font-semibold font-inter" style={{ color: "rgba(255, 205, 41, 1)", marginLeft: "36%"}}>
