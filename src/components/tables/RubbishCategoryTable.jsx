...
import { DeleteCategoryModal } from "../modal/rubbish-category/DeleteCategoryModal";
import { EditCategoryModal } from "../modal/rubbish-category/EditCategoryModal";
...
export function RubbishCategoryTable({ data, currentPage, itemsPerPage }) {
